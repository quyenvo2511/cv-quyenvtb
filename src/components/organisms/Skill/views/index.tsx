          ...
          <div className="professional-skills">
            ...
            <div className="skill">
              ...
              <div className="progress">
                <div
                  className="progress-bar progress4"
                  role="progressbar"
                  aria-valuenow={90}
                  aria-valuemin={0}
                  aria-valuemax={100}
            ...
            <div className="skill">
              ...
              <div className="progress">
                <div
                  className="progress-bar progress5"
                  role="progressbar"
                  aria-valuenow={80}
                  aria-valuemin={0}
                  aria-valuemax={100}
            ...
            <div className="skill">
              ...
              <div className="progress">
                <div
                  className="progress-bar progress3"
                  role="progressbar"
                  aria-valuenow={75}
                  aria-valuemin={0}
                  aria-valuemax={100}
            ...
            <div className="skill">
              ...
              <div className="progress">
                <div
                  className="progress-bar progress1"
                  role="progressbar"
                  aria-valuenow={75}
                  aria-valuemin={0}
                  aria-valuemax={100}
              ...
              <div className="row">
                <div className="col-sm-4">
                  <div className="circle">
                    ...
                    <div className="chart" data-percent="60"></div>
                ...
                <div className="col-sm-4">
                  <div className="circle">
                    ...
                    <div className="chart" data-percent="90"></div>
                    <div className="name-circle">
                      <span>Teamwork</span>
                    </div>
                  </div>
